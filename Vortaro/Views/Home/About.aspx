...
<asp:Content ID="aboutContent" ContentPlaceHolderID="MainContent" runat="server">
    <div style="width:100%">
        <h2>关于DBVortaro</h2>
        <p>如果你对DBVortaro有什么意见建议可以通过微博的方式联系到作者。<br/>
        ...
        1、共同参与并完善DBVortaro或用博客/微博把它分享它给更多的人。<br/>
        ...
        <a href='http://me.alipay.com/mkoplqq2006' target="_blank"><img alt="捐赠共勉" src='../../Content/Images/donate.png' border="0" /></a><br/>
        </p>
    </div>
</asp:Content>
